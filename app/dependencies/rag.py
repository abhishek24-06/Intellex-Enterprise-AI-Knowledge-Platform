...
def get_retrieval_service() -> RetrievalService:
    ...
    return RetrievalService(
        ...
        vector_search_repository=get_vector_search_repository(),
        reranker_service=get_reranker_service(),
    )


@lru_cache(maxsize=1)
def get_provider_client() -> ProviderLLMClient:
...
def get_answer_generation_service() -> AnswerGenerationService:
    ...
    return AnswerGenerationService(
        llm_client=get_provider_client(),
...
def get_rag_service() -> RAGService:
    ...
    return RAGService(
        ...
        answer_generation_service=get_answer_generation_service(),
    )