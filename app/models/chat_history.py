from sqlalchemy import Integer,String,DateTime,ForeignKey,Boolean,Enum, Text
...
class ChatHistory(Base):
    ...
    sources: Mapped[list["ChatSource"]] = relationship(back_populates="chat",cascade="all, delete-orphan")